...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/input_Username_username'), 'John De')

WebUI.setEncryptedText(findTestObject('Page_CURA Healthcare Service/input_Password_password'), '8nlnSHpkCjlhbY9lt8XXViPwJf/gDwla')
...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_April 2024SuMoTuWeThFrSa311234567891011_d88e31'))
